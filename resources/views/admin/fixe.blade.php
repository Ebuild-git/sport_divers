            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small">
                        <span class="menu-header-text" data-i18n="Evènement & Sponsors">Evènements & Sponsors</span>
                    </li>
                    <!-- Cards -->
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('events') }}" class="menu-link">
                                    <div data-i18n=" Liste des Evènements">Evènements</div>
                                </a>
                            </li>
                    ...
                    <!-- Components -->
                    <li class="menu-header small">
                        <span class="menu-header-text" data-i18n="Galleries">Galleries</span>
                    </li>
                    <!-- Cards -->
                     <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
