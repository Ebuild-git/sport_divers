                        ...
                        <div class="teams mt-25 md-mt-50">
                            <div class="row rs-vertical-middle">
                                <div class="col-md-4 col-sm-4 col-4">
                                    <div class="team-logo">
                                        <img class="size-80" src="{{ Storage::url($lastVideo->image) }}" alt="Valencia">
                    ...
                    <div class="rs-video rs-upcoming-match big-space bg1 bdru-4 text-center">
                        <div class="video-contents">
                            <a class="popup-videos play-btn"
                                onclick="playVideoInSmallPlayer('{{ Storage::url($lastVideo->video) }}')" {{--
                                onclick="openModal('{{ Storage::url($lastVideo->video) }}')" --}} {{--
                                href="https://www.youtube.com/watch?v=t17O6JoU2Ew" --}}><i class="fa fa-play"></i></a>
    ...
    <div class="rs-match-result style1 nav-style pb-100 md-pb-80">
        ...
        <div class="container">
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true"
                ...
                <div class="items" style="background-image: url('{{ Storage::url($latestVideo->image ?? 'path/to/default-image.jpg') }}');padding:2px;  width: 200px;
            ...
            <div class="row pl-15 pr-15">
                ...
                <div class="col-lg-4 col-md-6 padding-0 sm-mb-30">
                    <div class="gallery-grid">
                        <img src="{{ Storage::url($image->image) }}" width="200" height="200" alt="Gallery Image">
